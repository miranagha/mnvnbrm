    ...
    render() {
        return (
            <section>
                            ...
                            <Col md="8">
                                <Row>
                                    ...
                                    <Col md="10" className='jumbotron jumb'>
                                        <h1 style={{ color: '#f90' }} className='text-center'>Birmingham's Best Man and Van Service</h1>
                                        <br />
                                        <p className="text-eft">
                                            Man and Van Birmingham is the ultimate service for removals and packing services with eighteen years of
                                            ...
                                            Based in the West Midlands we cover the UK and the rest of Europe.
                                            ...
                                            <br /><br />
                                            Let Man and Van Birmingham make your next move unforgettable.
                                            <br /><br />
                ...
                <br />
                <article>
                    <h2 className='text-center h2'>Let Man and Van Birmingham take the stress out of your move</h2>
                    <br />
                    <Container>
                        <Row>
                            <Col className='jumbotron articles' md='4'>
                                <h3 className='text-center h3'>Birmingham Packing Service</h3>
                                <p>Man and Van Birmingham provides packing service that can be flexible to fit in with your needs and budget.
                        <br /> <br />
                                ...
                                <br /> <br />
                                    For the full packing service, the team at Man and Van Birmingham can pack all of your belongings for your home or business move.  This is the ultimate service for saving your time and reducing stress levels.  Let the experts worry about your move so you don’t have to.
                        </p>
                            </Col>
                            <Col className='jumbotron articles' md='4'>
                        ...
                        <br /> <br />
                                    Man and Van Birmingham has vast experience of helping customers to move home or office across the West Midlands.
                            ...
                            <Col className='jumbotron articles' md='4'>
                                ...
                                <p>Join our happy customers today and enjoy the best man and van services in the West Midlands.</p>
